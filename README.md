...
- `salir` o `exit`: Finaliza el programa y muestra resumen

## 📝 Notas

- Los datos se guardan inmediatamente después de introducir cada contacto
- El archivo CSV es compatible con Excel, Google Sheets y otras aplicaciones de hojas de cálculo
- Los contactos se añaden al final del archivo sin borrar los existentes

## 🤝 Contribuciones

Este es un programa educativo. Siéntete libre de modificarlo según tus necesidades.

## 📄 Licencia

Código de ejemplo para uso educativo y personal.

---

**Versión**: 1.0  
**Autor**: Rolodex Importer Team  
